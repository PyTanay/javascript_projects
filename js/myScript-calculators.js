function loadView() {
  ...
  main.innerHTML = `<${sessionStorage.getItem("calculators_view")} template="${sessionStorage.getItem(
    "calculators_view"
  )}"></${sessionStorage.getItem("calculators_view")}>`;
...
function loadTabs() {
  var arr1 = Object.getOwnPropertyNames(units);
